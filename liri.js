    ...
    request("http://www.omdbapi.com/?apikey=trilogy&t=" + media, function (error, response, data) {
        try {
            ...
            if (response.Title != undefined) {
                ...
                console.log(chalk.blue("*****************Year****************"));
                console.log(response.Year);
                console.log(chalk.blue("***" + response.Ratings[0].Source + " Rating****"));
                console.log(response.Ratings[0].Value);
               
                
                try {
                    console.log(chalk.blue("********" + response.Ratings[1].Source + " Rating*******"));
                ...
                console.log(chalk.blue("*****************Plot****************"));
                console.log(response.Plot);
                console.log(chalk.blue("****************Actors***************"));
